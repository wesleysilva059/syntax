					...
					'fields' => array( // Section Fields.
						'overlay'               => array(
							...
							'toggle'  => array(
								...
								'yes' => array(
									'fields' => array( 'overlay_color', 'overlay_icon', 'overlay_icon_color', 'overlay_icon_bg_color', 'overlay_icon_size' ),
								),
							),
						),
						'overlay_color'         => array(
				...
				'slide_box_min_height' => array( // Section.
					...
					'fields' => array( // Section Fields.
						'set_min_height'       => array(
							...
							'preview' => array(
								'type'     => 'css',
								'selector' => '.uabb-slide-box .uabb-slide-front',
								'property' => 'min-height',
								'unit'     => 'px',
							),
						),
